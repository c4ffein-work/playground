 ...
 *   NNVP_BACKEND_URL=http://127.0.0.1:8123 npm run test:contract
 *
 * These tests are intentionally excluded from `npm run test:unit`
 * (see vitest.config.js vs vitest.contract.config.js).
 */
